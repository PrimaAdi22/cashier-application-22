...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid px-4">
      <h1 class="mt-4"><b><font color='black'><font face="times">Tambah Penjualan Barang</font></h1>
      <div class="card mb-4">
        <div class="card-body">
          <form action="" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-2">
                <br>
                <button style="width: 100%;" type="button" class="btn btn-success mt-2" onclick="tambahBarang()"><font color='black'><font face="times">Tambah / Edit Data</font></button>
              </div>
            </div>
            <hr>
